...
//Test for checking modifiers for attributes are generated on button click

public class AttGenModTest {
    @Rule
    ...
    public void test() {
        onView(ViewMatchers.withId(R.id.normal))
                .perform(click());
        onView(withId(R.id.strengthMod)).check(matches(not(withText("-"))));
