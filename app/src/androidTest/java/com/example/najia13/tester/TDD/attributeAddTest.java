...
public class attributeAddTest extends ActivityInstrumentationTestCase2<CharacterActivity>{

    CharacterActivity mActivity;
    private TextView strength;

    @SuppressWarnings("deprecation")
    public attributeAddTest()
    {
    ...
    public void test() {
        ...
        onView(allOf(ViewMatchers.withId(R.id.bStrAdd))).perform(click());
