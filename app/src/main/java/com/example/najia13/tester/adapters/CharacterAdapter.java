...
public class CharacterAdapter extends RecyclerView.Adapter<CharacterAdapter.ViewHolder> {
    ...
    public CharacterAdapter(List<String> mstrings, Context context, OnClickListener callback) {
        mContext = context;
    ...
    public CharacterAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View menuView = inflater.inflate(R.layout.item_character_list, parent, false);
        ViewHolder viewHolder = new ViewHolder(menuView);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(CharacterAdapter.ViewHolder viewHolder, int position) {
