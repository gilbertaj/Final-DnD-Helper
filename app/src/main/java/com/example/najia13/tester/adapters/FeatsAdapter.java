 ...
 */
public class FeatsAdapter extends RecyclerView.Adapter<FeatsAdapter.ViewHolder> {
    ...
    public FeatsAdapter(List<String> mstrings, Context context, OnClickListener callback) {
        mContext = context;
    ...
    @Override
    public FeatsAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        Context context = parent.getContext();
        LayoutInflater inflater = LayoutInflater.from(context);

        View menuView = inflater.inflate(R.layout.item_feats_list, parent, false);
        ViewHolder viewHolder = new ViewHolder(menuView);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(FeatsAdapter.ViewHolder viewHolder, int position) {
