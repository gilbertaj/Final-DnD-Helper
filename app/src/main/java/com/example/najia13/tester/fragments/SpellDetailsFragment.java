...
public class SpellDetailsFragment extends Fragment {
    ...
    public static SpellDetailsFragment newInstance() {
        SpellDetailsFragment fragment = new SpellDetailsFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mview = inflater.inflate(R.layout.fragment_spell_details, container, false);
