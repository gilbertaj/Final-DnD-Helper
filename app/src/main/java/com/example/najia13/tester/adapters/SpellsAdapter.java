...
public class SpellsAdapter extends RecyclerView.Adapter<SpellsAdapter.ViewHolder> {
    ...
    public SpellsAdapter(List<String> mstrings, Context context, OnClickListener callback) {
        mContext = context;
    ...
    @Override
    public SpellsAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        Context context = parent.getContext();
        LayoutInflater inflater = LayoutInflater.from(context);

        View menuView = inflater.inflate(R.layout.item_spells_list, parent, false);
        ViewHolder viewHolder = new ViewHolder(menuView);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(SpellsAdapter.ViewHolder viewHolder, int position) {
